// Main.java
public class Main {
    public static <AudioBook> void main(String[] args) {
        ...
        AudioBook audiobook = new AudioBook  ("The Great Gatsby", "F. Scott Fitzgerald", 1925, "Jake Gyllenhaal", 5.2);
        ...
        ((Book) audiobook).changeTitle("The Great Gatsby: Illustrated");
